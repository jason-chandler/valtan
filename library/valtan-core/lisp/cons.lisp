...
(defun (common-lisp:setf car) (value cons) (rplaca cons value) value)
(defun (common-lisp:setf cdr) (value cons) (rplacd cons value) value)
...
(defun (common-lisp:setf caar) (value x) (rplaca (car x) value) value)
(defun (common-lisp:setf cadr) (value x) (rplaca (cdr x) value) value)
(defun (common-lisp:setf cdar) (value x) (rplacd (car x) value) value)
(defun (common-lisp:setf cddr) (value x) (rplacd (cdr x) value) value)
(defun (common-lisp:setf caaar) (value x) (rplaca (car (car x)) value) value)
(defun (common-lisp:setf caadr) (value x) (rplaca (car (cdr x)) value) value)
(defun (common-lisp:setf cadar) (value x) (rplaca (cdr (car x)) value) value)
(defun (common-lisp:setf caddr) (value x) (rplaca (cdr (cdr x)) value) value)
(defun (common-lisp:setf cdaar) (value x) (rplacd (car (car x)) value) value)
(defun (common-lisp:setf cdadr) (value x) (rplacd (car (cdr x)) value) value)
(defun (common-lisp:setf cddar) (value x) (rplacd (cdr (car x)) value) value)
(defun (common-lisp:setf cdddr) (value x) (rplacd (cdr (cdr x)) value) value)
(defun (common-lisp:setf caaaar) (value x) (rplaca (car (car (car x))) value) value)
(defun (common-lisp:setf caaadr) (value x) (rplaca (car (car (cdr x))) value) value)
(defun (common-lisp:setf caadar) (value x) (rplaca (car (cdr (car x))) value) value)
(defun (common-lisp:setf caaddr) (value x) (rplaca (car (cdr (cdr x))) value) value)
(defun (common-lisp:setf cadaar) (value x) (rplaca (cdr (car (car x))) value) value)
(defun (common-lisp:setf cadadr) (value x) (rplaca (cdr (car (cdr x))) value) value)
(defun (common-lisp:setf caddar) (value x) (rplaca (cdr (cdr (car x))) value) value)
(defun (common-lisp:setf cadddr) (value x) (rplaca (cdr (cdr (cdr x))) value) value)
(defun (common-lisp:setf cdaaar) (value x) (rplacd (car (car (car x))) value) value)
(defun (common-lisp:setf cdaadr) (value x) (rplacd (car (car (cdr x))) value) value)
(defun (common-lisp:setf cdadar) (value x) (rplacd (car (cdr (car x))) value) value)
(defun (common-lisp:setf cdaddr) (value x) (rplacd (car (cdr (cdr x))) value) value)
(defun (common-lisp:setf cddaar) (value x) (rplacd (cdr (car (car x))) value) value)
(defun (common-lisp:setf cddadr) (value x) (rplacd (cdr (car (cdr x))) value) value)
(defun (common-lisp:setf cdddar) (value x) (rplacd (cdr (cdr (car x))) value) value)
(defun (common-lisp:setf cddddr) (value x) (rplacd (cdr (cdr (cdr x))) value) value)
...
(defmacro push (obj place)
  (multiple-value-bind (vars vals stores store-form access-form)
    ...
    `(let* ,(common-lisp:mapcar #'common-lisp:list
                       (common-lisp:append vars stores)
                       (common-lisp:append vals (common-lisp:list (common-lisp:list 'cons obj access-form))))
       ,store-form)))
...
(defmacro pop (place)
  (multiple-value-bind (vars vals stores store-form access-form)
    ...
    `(let* ,(common-lisp:mapcar #'common-lisp:list
                       (common-lisp:append vars stores)
                       (common-lisp:append vals (common-lisp:list (common-lisp:list 'cdr access-form))))
       (prog1 (common-lisp:car ,access-form)
         ,store-form))))
...
(defmacro with-accumulate (() &body body)
  (let ((g-head (common-lisp:gensym))
        (g-tail (common-lisp:gensym)))
    `(let* ((,g-head (list nil))
            (,g-tail ,g-head))
       (labels ((collect (x)
...
(defun *::%mapcar (function list)
  (declare (common-lisp:type function function)
           (common-lisp:type common-lisp:list list))
  (with-accumulate ()
    (dolist (x list)
...
(defun get-properties (plist indicator-list)
  (do ((plist plist (cddr plist)))
      ((endp plist) (common-lisp:values nil nil nil))
    (when (member (car plist) indicator-list)
      (return (common-lisp:values (car plist) (cadr plist) plist)))))
...
(define-setf-expander getf (place indicator &optional default)
  (multiple-value-bind (vars vals stores store-form access-form)
      (!get-setf-expansion place)
    (let ((newval (common-lisp:gensym))
          (store (common-lisp:gensym)))
      (common-lisp:values `(,@vars ,newval)
                 `(,@vals ,indicator)
                 (list store)
...
(defun %remf (plist indicator)
  (do ((prev nil plist*)
      ...
      ((endp plist*) (common-lisp:values plist nil))
    (when (eq indicator (car plist*))
      (return (common-lisp:values (if (null prev)
                             (cddr plist)
                             (progn
